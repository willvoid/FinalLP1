...
public class NuevoUsuarioController implements ActionListener, KeyListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == gui.btn_guardar) {
            ...
            int clave = gui.txt_clave.getText().length();
            String txtusuario  = gui.txt_nombre.getText();
            String contraseña = gui.txt_clave.getText();
            String contraseña2 = gui.txt_repetirClave.getText();
            ...
            if (!contraseña.equals(contraseña2)) {
                ...
                gui.txt_repetirClave.requestFocus();
                return;
            }
    ...
    private Usuario getUsuarioForm() {
        ...
        usuario.setContraseña(gui.txt_clave.getText().trim());
    ...
    private boolean validarDatos() {
        ...
        if (gui.txt_repetirClave.getText().isEmpty()) {
            vacio = true;
        }
        return vacio;
    }
